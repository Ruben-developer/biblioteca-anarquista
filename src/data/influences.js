...
//
// Layout cronológico-vertical: Y = año de nacimiento (arriba = más antiguo,
// abajo = más reciente). X = afinidad ideológica/regional (izq = individualismo,
// centro = colectivismo/comunismo, der = contemporáneos/Latam).
export const influenceNodes = [
  // ── 1800s: fundadores ──
  { id: 'stirner', name: 'Stirner', years: '1806–1856', region: 'Alemania', authorKey: 'Max Stirner', x: 8, y: 95, bio: 'Autor de "El único y su propiedad": el egoísmo como base del individualismo radical.' },
  { id: 'proudhon', name: 'Proudhon', years: '1809–1865', region: 'Francia', authorKey: 'Pierre-Joseph Proudhon', x: 22, y: 93, bio: 'Padre del mutualismo y primer autoproclamado anarquista. Su pregunta "¿qué es la propiedad?" abre la tradición.' },
  // ── 1810s: organización ──
  { id: 'bakunin', name: 'Bakunin', years: '1814–1876', region: 'Rusia', authorKey: 'Mijaíl Bakunin', x: 38, y: 88, bio: 'Fundador del anarco-colectivismo y del anarquismo organizado en la Internacional.' },
  // ── 1820s: comunismo temprano + cristianismo ──
  { id: 'dejacque', name: 'Déjacque', years: '1821–1864', region: 'Francia', authorKey: 'Joseph Déjacque', x: 22, y: 82, bio: 'Primero en usar el término "libertario". Anarquista comunista frente al mutualismo de Proudhon.' },
  { id: 'tolstoi', name: 'Tolstói', years: '1828–1910', region: 'Rusia', authorKey: 'León Tolstói', x: 8, y: 78, bio: 'Anarquista cristiano: la no resistencia al mal y el pacifismo como revolución.' },
  // ── 1830s: geografía + comuna ──
  { id: 'reclus', name: 'Reclus', years: '1830–1905', region: 'Francia', authorKey: 'Élisée Reclus', x: 38, y: 73, bio: 'Geógrafo anarquista: la naturaleza y la sociedad se transforman juntas.' },
  { id: 'michel', name: 'Louise Michel', years: '1830–1905', region: 'Francia', authorKey: 'Louise Michel', x: 52, y: 73, bio: 'La "virgen roja" de la Comuna de París, poeta y militante incansable.' },
  ...
  { id: 'guerin', name: 'Guérin', years: '1904–1988', region: 'Francia', authorKey: 'Daniel Guérin', x: 52, y: 10, bio: 'Anarquista y escritor que unió anarquismo, autogestión y liberación sexual.' },
