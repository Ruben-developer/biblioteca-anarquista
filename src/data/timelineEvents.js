...
export const timelineEvents = [
  ...
  },
  {
    ...
    category: "historia",
    relatedTexts: ["El experimento del Kurdistán oeste (Kurdistán sirio)", "El Anarquismo Descolonizado: una historia de las experiencias antiautoritarias en Egipto (1860-2016)", "Hacia un estudio decolonial del anarquismo. Egipto y Túnez", "Enrabiaos, apuntes sobre la spanishrevolution", "La bala y la escuela", "La revolución ignorada. Liberación de la mujer, democracia directa y pluralismo radical en Oriente Medio", "Revolución en Rojava. Liberación de la mujer y comunalismo entre la guerra y el embargo"]
  },
  {
    year: 1874,
    decade: "1870s",
