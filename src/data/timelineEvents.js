...
export const timelineEvents = [
  {
    ...
    category: "historia",
    relatedTexts: ["Utopías antiguas y modernas", "Prehistoria del anarquismo", "El anarquismo en la antigua Grecia", "Los hermanos de la Costa. Piratería libertaria en el Caribe", "Colón y la civilización occidental", "La Gran Revolución (1789-1793) (Vol. I)"]
  },
  {
    year: 1868,
    decade: "1860s",
    ...
    category: "historia",
    relatedTexts: ["La Comuna de París", "La comuna de París (antología)", "Bakunin-Netchaiev. El Catecismo Revolucionario", "Bakunin y la guerra franco-prusiana", "Mijaíl Bakunin, la Internacional y la Alianza en España (1868-1873)"]
  },
  {
    year: 1886,
    decade: "1880s",
