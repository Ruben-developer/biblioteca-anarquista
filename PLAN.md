...
## 6. Próximo día
 ...
 - [x] **Favicon con el logo anarquista (imagen del usuario)** ⏳ 2026-08-18: el usuario va a enviar la imagen (`/home/nbk/Imágenes/40386.png` no accesible desde esta máquina — usuario `nbk` existe pero su home no está montado aquí). Cuando llegue: convertir a SVG/PNG en `public/` y apuntar `<link rel="icon">` en `index.html`. Mientras tanto el favicon actual sigue siendo la A encerrada en círculo.
